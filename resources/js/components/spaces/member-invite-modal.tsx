                ...
                <form onSubmit={submit}>
                    <DialogHeader>
                        <DialogTitle className="flex items-center gap-2">
                            <UserPlus className="h-5 w-5 text-primary" /> Invite
                            Member
                        </DialogTitle>
                        <DialogDescription>
                            Enter an email address. If the user exists they'll
                            be added immediately, otherwise they'll receive an
                            invite email.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="grid gap-6 py-4">
                        ...
                        <div className="flex items-start gap-3 rounded-lg bg-muted/40 p-3 text-xs text-muted-foreground">
                            ...
                            <p>
                                If this email isn't registered, we'll send them
                                an invitation link valid for 7 days. They'll be
                                added with the selected role upon joining.
                            </p>
                        </div>
                    </div>
